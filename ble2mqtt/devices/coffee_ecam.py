...
from .base import SELECT_DOMAIN, SENSOR_DOMAIN, SWITCH_DOMAIN, ConnectionMode, Device
...
class ECAMCoffeeMaker(ECAMProtocol, Device):
    ...
    SEND_DATA_PERIOD = 5  # seconds when making coffee
    ...
    def __init__(self, mac, key='ffffffffffffffff', default_program='express',
        ...
        self._state: CoffeeMachineState = None
    ...
    async def notify_run_state(self, new_state: CookerState, publish_topic):
        if not self.initial_status_sent or \
            ...
            await aio.gather(
                publish_topic(topic=self._get_topic(COFFEE_ENTITY), value=mode),
    ...
    "name"]} value={value}',
        ...
        while True:
            ...
            entity = self.get_entity_by_name(SWITCH_DOMAIN, COFFEE_ENTITY)
